...
if ($#ARGV<13) {
    print "USE: maps_orion.pl map.fits min max bright contrast Label factor dev VAL_TO_WHITE MAP_CONT NLEVELS MIN STEP NWHITE[49] [TABLE REVERSE]\n";
    exit;
}
$mapfile=$ARGV[0];
$min=$ARGV[1];
