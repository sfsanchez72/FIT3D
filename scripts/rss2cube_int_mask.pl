...
if ($#ARGV<6) {
    print "USE: rss2cube_int_mask.pl INPUT_RSS MASK_RSS position_table.txt dx OUTPUT.cube.fits alpha BOX SCALE\n";
    print "type:\n";
