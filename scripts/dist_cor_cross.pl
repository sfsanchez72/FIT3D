...
if ($#ARGV<6) {
    print "USE: dist_cor_cross.pl EXTRACTED.fits CORRECTED.fits DISTORSION_CORRECTION.txt SMOOTH[0/1] start_index delta_index plot [y_index] [nsigma] [REF.fits]\n";
    exit;
}
