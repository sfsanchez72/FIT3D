...
if ($#ARGV<3) {
    print "USE: fit_3D_force_delta.pl E3D_FITSFILE CONFIG_FILE INPUT_FILE OUT_FILE [FRE_FRACT] [WAIT] [DELTA] [BIAS]\n";    
    exit;
}
...
#
    ...
    print TCL "create_env euro3d /null\n";
    print TCL "euro3d load_file $e3d_file\n"; 
    print TCL "euro3d create_slice $j_start $j_end 1 0\n";
    print TCL "euro3d save_slice 1 $slice_file Flux 1\n";
    print TCL "exit\n";
    close(TCL);
    system("$tk_e3d fit.tcl");
