...
#		    $call="/home/sanchez/sda2/code/FIT3D/bin/fit_spec_back fit_spectra.input tmp.config ".$back_file." ".$nback." ".$device;
		    if ($nf>0) {
		    $call="/home/sanchez/sda2/code/FIT3D/bin/fit_spec_back_fits fit_spectra.input tmp.config BACK_JUNK.fits ".$nback." ".$device;
		} else {
		    $call="/home/sanchez/sda2/code/FIT3D/bin/fit_spec_back fit_spectra.input tmp.config none 0 ".$device;
		}
