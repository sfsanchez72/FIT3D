...
if ($#ARGV<5) {
    print "USE: table_plot_log.pl ASCII_TABLE.txt N.COLUMN1(0...N)  N.COLUMN2(0...N) LABEL1 LABEL2 DEV [MIN MAX] [YMIN YMAX] [FIX]\n";
    exit;
}
...
pgenv($x_min,$x_max,$y_min,$y_max,$fix,30);
