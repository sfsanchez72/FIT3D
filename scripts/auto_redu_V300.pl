...
if ($nbias>3) {
    ...
    mycall($call);
    $call="imstats.pl bias.fits 520 1080 50 50 > bias.mean";
    mycall($call);
    dumplog("mean_bias","bias.mean");
} else {
    if ($nbias>0) {
...
$call="imstats_hist.pl mbias.fits 520 1080 50 50 mbias.ps/CPS 10 > bias.mean";
mycall($call);
dumplog("median_bias","bias.mean");
...
#
    ...
    mycall($call);
    $call="fiber_flat_ppak.pl sky_1.disp_cor.fits fiberflat.fits";
    mycall($call);
    $call="cp fiberflat.fits fiberflat.".$TODAY.".fits";
    mycall($call);
    $call="split_ppak.pl fiberflat.fits fiberflat.obj.fits fiberflat.cal.fits fiberflat.sky.fits 0";
    mycall($call);
...
if ($nstd_1>0) {
    ...
    $call="radial_sum_rss.pl ".$pre_std_1.".sobj.fits ".$DIR_CONF."/ppak_pt_arc.txt 5 0 0 std_1.rss.fits 2";
    mycall($call);
    $call="img2spec.pl std_1.rss.fits 3 spec_std_1.txt";
    mycall($call);
    $call="cp radial_sum_rss_3.ps spec_std_1_aper.ps";
    mycall($call);
...
#    while ($date[$NC]<$date_obs) {
    ...
    mycall($call);
    $call="cp ratio.txt ratio_std_1.txt";
    mycall($call);

    print LOG "#STARNDARDS $name_std_1, ratio_std_1.txt\n";
...
#($pre_std_2,$post)=split(/\./,$std_2);
	...
	$call="radial_sum_rss.pl ".$pre_std_2.".sobj.fits ".$DIR_CONF."/ppak_pt_arc.txt 5 0 0 std_2.rss.fits 2";
	mycall($call);
	$call="img2spec.pl std_2.rss.fits 3 spec_std_2.txt";
	mycall($call);
	$call="cp radial_sum_rss_3.ps spec_std_2_aper.ps";
	mycall($call);
	...
	$call="calib_det.pl spec_std_2.txt ".$DIR_CONF."/f".$name_std_2.".dat ratio_std_2.txt ".$factor." ".$extinction." ".$airmass." 1 11 0 3640 6800";
	mycall($call);


	print LOG "#STARNDARDS $name_std_2, ratio_std_2.txt\n";
	...
	$line=<FH>;
	close(FH);
	print LOG "#FLUX_CALIBRATIION_ ACCURACY $line";
	$call="ls ratio_std_*.txt > list_ratios.txt";
	mycall($call);
	$call="spectra_plot.pl list_ratios.txt ratios.ps/CPS";
	mycall($call);
...
#    while ($date[$NC]<$date_obs) {
    ...
    mycall($call);
    $call="check_wavelength_cal.pl junk.obj.fits ".$DIR_CONF."/emission_lines.sky 3620 3.2 64 2 0";
    mycall($call);
    ...
    $call="get_flux_width.pl junk.sobj.fits ".$DIR_CONF."/emission_lines.sky 20 3620 3.2 /null > junk.sobj.flux";
    mycall($call);
    $call="get_flux_width.pl junk.obj.fits ".$DIR_CONF."/emission_lines.sky 20 3620 3.2 /null > junk.obj.flux";
    mycall($call);
...
# ************************************
#
    $call="get_flux_stats.pl obj_p1.sobj.fits 5700 30 3620 3.2 SN_".$name_obj[$j]."_p1.ps/CPS 1 > ".$name_obj[$j]."_p1.out ";
    mycall($call);
...
# 
    ...
    $call="radial_sum_rss.pl obj_p1.sobj.fits ".$DIR_CONF."/ppak_pt_arc.txt 5 0 0 rad_1.rss.fits 2";
    mycall($call);
    ...
    $call="radial_sum_rss.pl obj_p2.sobj.fits ".$DIR_CONF."/ppak_pt_arc.txt 5 0 0 rad_2.rss.fits 2";
    mycall($call);
    ...
    $call="radial_sum_rss.pl obj_p3.sobj.fits ".$DIR_CONF."/ppak_pt_arc.txt 5 0 0 rad_3.rss.fits 2";
    mycall($call);
...
#
    ...
    $call="get_flux_stats_cube.pl ".$name_obj[$j].".cube.fits 5800 40 3620 3.2 SN_".$name_obj[$j].".ps/CPS 1 > SN_".$name_obj[$j].".out";
    mycall($call);
...
#	while ($date[$NC]<$date_obs) {
	...
	$call="get_flux_stats_cube.pl ".$name_obj_now.".1P.cube.fits 5800 40 3620 3.2 SN_".$name_obj_now.".1P.ps/CPS 1 > SN_".$name_obj_now.".1P.out";
	mycall($call);
...
#	exit;
	...
	$call="radial_sum_rss.pl obj_p".$p_now[0].".sobj.fits ".$DIR_CONF."/ppak_pt_arc.txt 5 0 0 rad_1.rss.fits 2";
	mycall($call);
	$call="img2spec.pl rad_1.rss.fits 4 rad_1.txt";
	mycall($call);
	open(FH,"flux_filter.pl /disk-b/sanchez/ppak/legacy/V_Johnson.txt rad_1.txt 0 |");
	...
	$call="radial_sum_rss.pl obj_p".$p_now[1].".sobj.fits ".$DIR_CONF."/ppak_pt_arc.txt 5 0 0 rad_2.rss.fits 2";
	mycall($call);
	$call="img2spec.pl rad_2.rss.fits 4 rad_2.txt";
	mycall($call);
	open(FH,"flux_filter.pl /disk-b/sanchez/ppak/legacy/V_Johnson.txt rad_2.txt 0 |");
	...
	$call="get_flux_stats_cube.pl ".$name_obj_now.".2P.cube.fits 5800 40 3620 3.2 SN_".$name_obj_now.".2P.ps/CPS 1 > SN_".$name_obj_now.".2P.out";
	mycall($call);
    }
...
open(OUTSKY,">auto_redu_V300.sky_list");
open(OUTMAG,">auto_redu_V300.sky_mag");
...
$call="spectra_plot.pl auto_redu_V300.sky_list skys_plot.ps/CPS -1 10";
mycall($call);

$label1="Julian DATE";
$label2="Night-sky V-band (mag/arcsec\u2\d)";
$call="table_plot.pl auto_redu_V300.sky_mag 11 1 \"".$label1."\" \"".$label2."\" sky_mag_date.ps/CPS";
mycall($call);

$label1="Airmass";
$label2="Night-sky V-band (mag/arcsec\u2\d)";
$call="table_plot.pl auto_redu_V300.sky_mag 10 1 \"".$label1."\" \"".$label2."\" sky_mag_airmass.ps/CPS";
mycall($call);
...
open(FH,"<auto_redu_V300.sky_list");
while($file=<FH>) {
    chop($file);
    $psfile=$file;
    $psfile =~ s/txt/ps/;
